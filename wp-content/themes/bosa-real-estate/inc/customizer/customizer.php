 ...
 */
add_action( 'customize_preview_init', 'bosa_real_estate_customize_preview_js', 999, 1 );

function bosa_real_estate_customize_preview_js() {
	wp_enqueue_script( 'bosa-real-estate-customizer', get_stylesheet_directory_uri() . '/inc/customizer/customizer.js', array( 'customize-preview' ) );
}

function bosa_real_estate_customize_getting_js() {
	wp_dequeue_script( 'bosa-customizer-getting-started' );
	wp_enqueue_script( 'bosa-real-estate-customizer-getting-started', get_stylesheet_directory_uri() . '/inc/getting-started/getting-started.js', array( 'customize-controls', 'jquery' ), true );

	wp_enqueue_style( 'bosa-real-estate-customize-controls', get_stylesheet_directory_uri() . '/inc/customizer/customizer.css' );
}
add_action( 'customize_controls_enqueue_scripts', 'bosa_real_estate_customize_getting_js', 99 );
 ...
 * @return void
 */
add_action( 'init' , 'bosa_real_estate_kirki_fields', 999, 1 );

function bosa_real_estate_kirki_fields(){
	...
	*/
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Site Title', 'bosa-real-estate' ),
		'type'         => 'typography',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Site Description', 'bosa-real-estate' ),
		'type'         => 'typography',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Main Menu', 'bosa-real-estate' ),
		'type'         => 'typography',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Main Menu Description', 'bosa-real-estate' ),
		'type'         => 'typography',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Body', 'bosa-real-estate' ),
		'type'         => 'typography',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'General Title (H1 - H6)', 'bosa-real-estate' ),
		'type'         => 'typography',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Page & Single Post Title', 'bosa-real-estate' ),
		'type'         => 'typography',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Title Typography', 'bosa-real-estate' ),
		'type'         => 'typography',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Category Typography', 'bosa-real-estate' ),
		'type'         => 'typography',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Meta Typography', 'bosa-real-estate' ),
		'type'         => 'typography',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Excerpt Typography', 'bosa-real-estate' ),
		'type'         => 'typography',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Slider Button Typography', 'bosa-real-estate' ),
		'type'         => 'typography',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Content Alignment', 'bosa-real-estate' ),
		'type'        => 'select',
		'settings'    => 'main_slider_content_alignment',
		'section'     => 'main_slider_options',
		'default'     => 'left',
		'choices'  => array(
			'center' => esc_html__( 'Center', 'bosa-real-estate' ),
			'left'   => esc_html__( 'Left', 'bosa-real-estate' ),
			'right'  => esc_html__( 'Right', 'bosa-real-estate' ),
		),
		'priority'	  =>  180,
		'active_callback' => array(
			array(
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Section Title Typography', 'bosa-real-estate' ),
		'type'         => 'typography',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Section Description Typography', 'bosa-real-estate' ),
		'type'         => 'typography',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Post Title Typography', 'bosa-real-estate' ),
		'type'         => 'typography',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Post Category Typography', 'bosa-real-estate' ),
		'type'         => 'typography',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Post Meta Typography', 'bosa-real-estate' ),
		'type'         => 'typography',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Post Excerpt Typography', 'bosa-real-estate' ),
		'type'         => 'typography',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Widget Title Typography', 'bosa-real-estate' ),
		'type'         => 'typography',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Header Layouts', 'bosa-real-estate' ),
		'description' => esc_html__( 'Select layout & scroll below to change its options', 'bosa-real-estate' ),
		'type'        => 'radio-image',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Disable Top Header Section', 'bosa-real-estate' ),
		'type'         => 'checkbox',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Header Height (in px)', 'bosa-real-estate' ),
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Disable Contact Details', 'bosa-real-estate' ),
		'type'         => 'checkbox',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Contact Detail Icon color', 'bosa-real-estate' ),
		'type'         => 'color',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Phone Label', 'bosa-real-estate' ),
		'type'         => 'text',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Phone Number', 'bosa-real-estate' ),
		'type'         => 'text',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Email Label', 'bosa-real-estate' ),
		'type'         => 'text',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Email', 'bosa-real-estate' ),
		'type'         => 'text',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Address Label', 'bosa-real-estate' ),
		'type'         => 'text',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Address', 'bosa-real-estate' ),
		'type'         => 'text',
	...
	Kirki::add_field( 'bosa', array(
	    ...
	    'section'     => 'header_style_options',
	    'default'     => esc_html__( 'Header Button Options', 'bosa-real-estate' ),
	    'priority'	  => 550,
	    'active_callback' => array(
			array(
				'setting'  => 'header_layout',
	...
	// Header button
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Disable Header Buttons', 'bosa-real-estate' ),
		'type'         => 'checkbox',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Header Buttons', 'bosa-real-estate' ),
		'type'         => 'repeater',
		'settings'     => 'header_button_repeater',
		'section'      => 'header_style_options',
		'row_label' => array(
			'type'  => 'text',
			'value' => esc_html__( 'Button', 'bosa-real-estate' ),
		),
		'default' => array(
			array(
		...
		'fields' => array(
			'header_btn_type' => array(
				'label'       => esc_html__( 'Button Type', 'bosa-real-estate' ),
				'type'        => 'select',
				'default'     => 'button-outline',
				'choices'  	  => array(
					'button-primary' => esc_html__( 'Background Button', 'bosa-real-estate' ),
					'button-outline' => esc_html__( 'Border Button', 'bosa-real-estate' ),
					'button-text'    => esc_html__( 'Text Only Button', 'bosa-real-estate' ),
				),
			),
			'header_btn_bg_color' 	=> array(
				'label'       		=> esc_html__( 'Non Transparent Header Button Background Color', 'bosa-real-estate' ),
				'description' 		=> esc_html__( 'For background button type only.', 'bosa-real-estate' ),
				'type'        		=> 'color',
				'default'     		=> '#EB5A3E',
			),
			'header_btn_border_color' 	=> array(
				'label'      	 		=> esc_html__( 'Non Transparent Header Button Border Color', 'bosa-real-estate' ),
				'description' 			=> esc_html__( 'For border button type only.', 'bosa-real-estate' ),
				'type'       		 	=> 'color',
				'default'     			=> '#1a1a1a',
			),
			'header_btn_text_color' => array(
				'label'       		=> esc_html__( 'Non Transparent Header Button Text Color', 'bosa-real-estate' ),
				'type'        		=> 'color',
				'default'     		=> '#1a1a1a',
			),
			'header_btn_hover_color' => array(
				'label'       		=> esc_html__( 'Non Transparent Header Button Hover Color', 'bosa-real-estate' ),
				'type'        		=> 'color',
				'default'     		=> '#086abd',
			),
			'header_btn_text' => array(
				'label'       => esc_html__( 'Button Text', 'bosa-real-estate' ),
				'type'        => 'text',
				'default' 	  => '',
			),
			'header_btn_link' => array(
				'label'       => esc_html__( 'Button Link', 'bosa-real-estate' ),
				'type'        => 'text',
				'default' 	  => '#',
			),
			'header_btn_target' => array(
				'label'       	=> esc_html__( 'Open Link in New Window', 'bosa-real-estate' ),	
				'type'        	=> 'checkbox',
				'default'	  	=> true,
			),
			'header_btn_radius' => array(
				'label'       	=> esc_html__( 'Button Radius (px)', 'bosa-real-estate' ),
				'type'        	=> 'number',
				'default'	  	=> 0,
				'choices'     	=> array(
					'min'  => 0,
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Header Buttons Typography', 'bosa-real-estate' ),
		'type'         => 'typography',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Header Hamburger Icon Background Color', 'bosa-real-estate' ),
		'type'         => 'color',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Header Hamburger Icon Color', 'bosa-real-estate' ),
		'type'         => 'color',
	...
	Kirki::add_field( 'bosa', array(
	    ...
	    'section'     => 'header_style_options',
	    'default'     => esc_html__( 'Contact Details Options', 'bosa-real-estate' ),
	    'priority'	   => 440,
	    'active_callback' => array(
			array(
				'setting'  => 'header_layout',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Contact Label Typography', 'bosa-real-estate' ),
		'type'         => 'typography',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Contact Content Typography', 'bosa-real-estate' ),
		'type'         => 'typography',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Disable Mid Header Section Border', 'bosa-real-estate' ),
		'type'         => 'checkbox',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Disable Header Contact Details', 'bosa-real-estate' ),
		'type'        => 'checkbox',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Footer Layouts', 'bosa-real-estate' ),
		'type'        => 'radio-image',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Bottom Footer Typography', 'bosa-real-estate' ),
		'type'         => 'typography',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Select Image', 'bosa-real-estate' ),
		'type'         => 'image',
	...
	Kirki::add_field( 'bosa', array(
		'label'    => esc_html__( 'Image Link', 'bosa-real-estate' ),
		'type'     => 'link',
	...
	Kirki::add_field( 'bosa', array(
		'label'    => esc_html__( 'Image Target', 'bosa-real-estate' ),
		'description' => esc_html__( 'If enabled, the page will be open in an another browser tab.', 'bosa-real-estate' ),
		'type'     => 'checkbox',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Image Width', 'bosa-real-estate' ),
		'type'         => 'slider',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Disable Section Border', 'bosa-real-estate' ),
		'type'         => 'checkbox',
	...
	Kirki::add_section( 'feature_posts_options', array(
	    'title'          => esc_html__( 'Featured Posts / Pages', 'bosa-real-estate' ),
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Featured Posts / Pages', 'bosa-real-estate' ),
		...
		'priority'    => '9',
		'choices'  => array(
			'featured_posts' => esc_html__( 'Featured Posts', 'bosa-real-estate' ),
			'featured_pages' => esc_html__( 'Featured Pages', 'bosa-real-estate' ),
		)
	) );

	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Disable Featured Posts Section', 'bosa-real-estate' ),
		'type'         => 'checkbox',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Disable Section Title', 'bosa-real-estate' ),
		'type'         => 'checkbox',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Section Title', 'bosa-real-estate' ),
		'type'        => 'text',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Disable Section Description', 'bosa-real-estate' ),
		'type'         => 'checkbox',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Section Description', 'bosa-real-estate' ),
		'type'        => 'text',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Section Title and Description Alignment', 'bosa-real-estate' ),
		'type'        => 'select',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Section Layout', 'bosa-real-estate' ),
		'description' => esc_html__( 'Select layout & scroll below to change its options', 'bosa-real-estate' ),
		'type'        => 'radio-image',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Post Title Color', 'bosa-real-estate' ),
		'type'         => 'color',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Post Category Background Color', 'bosa-real-estate' ),
		'type'         => 'color',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Post Category Color', 'bosa-real-estate' ),
		'type'         => 'color',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Post Meta Text Color', 'bosa-real-estate' ),
		'type'         => 'color',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Post Meta Icon Color', 'bosa-real-estate' ),
		'type'         => 'color',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Post Hover Color', 'bosa-real-estate' ),
		'type'         => 'color',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Columns', 'bosa-real-estate' ),
		'type'        => 'select',
		'settings'    => 'feature_posts_columns',
		'section'     => 'feature_posts_options',
		'default'     => 'three_columns',
		'placeholder' => esc_attr__( 'Select category', 'bosa-real-estate' ),
		'choices'  => array(
			'one_column'    => esc_html__( '1 Column', 'bosa-real-estate' ),
			'two_columns'   => esc_html__( '2 Columns', 'bosa-real-estate' ),
			'three_columns' => esc_html__( '3 Columns', 'bosa-real-estate' ),
			'four_columns'  => esc_html__( '4 Columns', 'bosa-real-estate' ),
		),
		'priority'	  =>  160,
		'active_callback' => array(
			array(
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Choose Category', 'bosa-real-estate' ),
		'description' => esc_html__( 'Recent posts will show if any category is not chosen.', 'bosa-real-estate' ),
		'type'        => 'select',
		'settings'    => 'feature_posts_category',
		'section'     => 'feature_posts_options',
		'default'     => '',
		'placeholder' => esc_html__( 'Select category', 'bosa-real-estate' ), 
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Featured Posts Overlay Opacity', 'bosa-real-estate' ),
		'type'        => 'number',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Post View Number', 'bosa-real-estate' ),
		'description'  => esc_html__( 'Number of posts to show.', 'bosa-real-estate' ),
		'type'         => 'number',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Height (in px)', 'bosa-real-estate' ),
		'description'  => esc_html__( 'This option will only apply to Desktop. Please click on below Desktop Icon to see changes. Automatically adjust by theme default in the responsive devices.
		', 'bosa-real-estate' ),
		'type'         => 'slider',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Choose Image Size', 'bosa-real-estate' ),
		'type'        => 'select',
		'settings'    => 'render_feature_post_image_size',
		'section'     => 'feature_posts_options',
		'default'     => 'bosa-420-300',
		'placeholder' => esc_html__( 'Select Image Size', 'bosa-real-estate' ),
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Background Image Size', 'bosa-real-estate' ),
		'type'         => 'radio',
		'settings'     => 'feature_posts_image_size',
		'section'      => 'feature_posts_options',
		'default'      => 'cover',
		'choices'      => array(
			'cover'    => esc_html__( 'Cover', 'bosa-real-estate' ),
			'pattern'  => esc_html__( 'Pattern / Repeat', 'bosa-real-estate' ),
			'norepeat' => esc_html__( 'No Repeat', 'bosa-real-estate' ),
		),
		'priority'	   =>  220,
		'active_callback' => array(
			array(
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Posts Border Radius (px)', 'bosa-real-estate' ),
		'type'        => 'slider',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Post Text Alignment', 'bosa-real-estate' ),
		'type'        => 'select',
		'settings'    => 'feature_posts_text_alignment',
		'section'     => 'feature_posts_options',
		'default'     => 'text-left',
		'choices'     => array(
			'text-left'	 	=> esc_html__( 'Left', 'bosa-real-estate' ),
			'text-center'  	=> esc_html__( 'Center', 'bosa-real-estate' ),   
			'text-right'	=> esc_html__( 'Right', 'bosa-real-estate' ),
		),
		'priority'	  =>  240,
		'active_callback' => array(
			array(
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Post Content Alignment', 'bosa-real-estate' ),
		'type'        => 'select',
		'settings'    => 'feature_posts_title_alignment',
		'section'     => 'feature_posts_options',
		'default'     => 'align-bottom',
		'choices'     => array(
			'align-top'	 	=> esc_html__( 'Top', 'bosa-real-estate' ),
			'align-center'  => esc_html__( 'Center', 'bosa-real-estate' ),   
			'align-bottom'  => esc_html__( 'Bottom', 'bosa-real-estate' ),
		),
		'priority'	  =>  250,
		'active_callback' => array(
			array(
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Disable Post Title', 'bosa-real-estate' ),
		'type'        => 'checkbox',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Disable Post Title Divider', 'bosa-real-estate' ),
		'type'        => 'checkbox',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Disable Posts category', 'bosa-real-estate' ),
		'type'        => 'checkbox',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Disable Post Date', 'bosa-real-estate' ),
		'type'        => 'checkbox',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Disable Post Author', 'bosa-real-estate' ),
		'type'        => 'checkbox',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Disable Post Comment', 'bosa-real-estate' ),
		'type'        => 'checkbox',
	...
	// featured pages
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Disable Featured Pages Section', 'bosa-real-estate' ),
		'type'         => 'checkbox',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Page 1', 'bosa-real-estate' ),
		'type'        => 'select',
		'settings'    => 'featured_pages_one',
		'section'     => 'feature_posts_options',
		'default'     => '',
		'placeholder' => esc_html__( 'Select Page 1', 'bosa-real-estate' ),
		'choices'     => bosa_real_estate_get_pages(),
		'priority'	  => 450,
		'active_callback' => array(
			array(
				'setting'  => 'feature_posts_pages_tab',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Page 2', 'bosa-real-estate' ),
		'type'        => 'select',
		'settings'    => 'featured_pages_two',
		'section'     => 'feature_posts_options',
		'default'     => '',
		'placeholder' => esc_html__( 'Select Page 2', 'bosa-real-estate' ),
		'choices'     => bosa_real_estate_get_pages(),
		'priority'	  => 460,
		'active_callback' => array(
			array(
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Page 3', 'bosa-real-estate' ),
		'type'        => 'select',
		'settings'    => 'featured_pages_three',
		'section'     => 'feature_posts_options',
		'default'     => '',
		'choices'     => bosa_real_estate_get_pages(),
		'placeholder' => esc_html__( 'Select Page 3', 'bosa-real-estate' ),
		'priority'	  => 470,
		'active_callback' => array(
			array(
				'setting'  => 'feature_posts_pages_tab',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Page 4', 'bosa-real-estate' ),
		'type'        => 'select',
		'settings'    => 'featured_pages_four',
		'section'     => 'feature_posts_options',
		'default'     => '',
		'choices'     => bosa_real_estate_get_pages(),
		'placeholder' => esc_html__( 'Select Page 4', 'bosa-real-estate' ),
		'priority'	  => 480,
		'active_callback' => array(
			array(
				'setting'  => 'feature_posts_pages_tab',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Featured Page Overlay Opacity', 'bosa-real-estate' ),
		'type'        => 'number',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Page Border Radius (px)', 'bosa-real-estate' ),
		'type'        => 'slider',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Disable Page Title', 'bosa-real-estate' ),
		'type'        => 'checkbox',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Page Title Color', 'bosa-real-estate' ),
		'type'         => 'color',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Page Hover Color', 'bosa-real-estate' ),
		'type'         => 'color',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Page Title Horizontal Alignment', 'bosa-real-estate' ),
		'type'        => 'select',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Page Title Vertical Alignment', 'bosa-real-estate' ),
		'type'        => 'select',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Page Title Typography', 'bosa-real-estate' ),
		'type'         => 'typography',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Disable Featured Posts / Pages', 'bosa-real-estate' ),
		'type'         => 'checkbox',
	...
	Kirki::add_section( 'blog_advert_banner_options', array(
	    'title'          => esc_html__( 'Blog Advertisement Banner', 'bosa-real-estate' ),
	    'panel'          => 'blog_homepage_options',
	    'capability'     => 'edit_theme_options',
	    'priority'       => '24',
	) );
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Advertisement Banner', 'bosa-real-estate' ),
		'description'  => esc_html__( 'Image dimensions 1230 by 100 pixels is recommended.', 'bosa-real-estate' ),
		'type'         => 'image',
	...
	Kirki::add_field( 'bosa', array(
		'label'    => esc_html__( 'Advertisement Banner Link', 'bosa-real-estate' ),
		'type'     => 'link',
	...
	Kirki::add_field( 'bosa', array(
		'label'    		=> esc_html__( 'Advertisement Banner Target', 'bosa-real-estate' ),
		'description' 	=> esc_html__( 'If enabled, the page will be open in an another browser tab.', 'bosa-real-estate' ),
		'type'     		=> 'checkbox',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Disable Advertisement Banner', 'bosa-real-estate' ),
		'type'         => 'checkbox',
	...
	Kirki::add_section( 'feature_posts_two_options', array(
	    'title'          => esc_html__( 'Featured Posts Two', 'bosa-real-estate' ),
	    'panel'          => 'blog_homepage_options',
	    'capability'     => 'edit_theme_options',
	    'priority'       => 25,
	) );
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Disable Featured Posts Two Section', 'bosa-real-estate' ),
		'type'         => 'checkbox',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Posts Overlay Opacity', 'bosa-real-estate' ),
		'type'        => 'number',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Post Content Horizontal Alignment', 'bosa-real-estate' ),
		'type'        => 'select',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Post Content Vertical Alignment', 'bosa-real-estate' ),
		'type'        => 'select',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Disable Featured Posts Two', 'bosa-real-estate' ),
		'type'         => 'checkbox',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Post Layouts', 'bosa-real-estate' ),
		'description' => esc_html__( 'Grid / List / Single/ Grid Thumbnail', 'bosa-real-estate' ),
		'type'        => 'radio-image',
	...
	Kirki::add_field( 'bosa', array(
	    ...
	    'section'     => 'blog_page_style_options',
	    'default'     => esc_html__( 'Thumbnail Post Options', 'bosa-real-estate' ),
	    'priority'	  => 300,
	    'active_callback' => array(
			array(
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Choose Image Size', 'bosa-real-estate' ),
		'description' => esc_html__( 'Image Size for thumbnail post only.', 'bosa-real-estate' ),
		'type'        => 'select',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Post Border Radius (px)', 'bosa-real-estate' ),
		'description' => esc_html__( 'Post Border Radius for thumbnail post only.', 'bosa-real-estate' ),
		'type'        => 'slider',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Disable Date', 'bosa-real-estate' ),
		'description'  => esc_html__( 'Disables date for thumbnail post only.', 'bosa-real-estate' ),
		'type'         => 'checkbox',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Disable Author', 'bosa-real-estate' ),
		'description'  => esc_html__( 'Disables author for thumbnail post only.', 'bosa-real-estate' ),
		'type'         => 'checkbox',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Disable Comment Link', 'bosa-real-estate' ),
		'description'  => esc_html__( 'Disables comment link for thumbnail post only.', 'bosa-real-estate' ),
		'type'         => 'checkbox',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Disable Excerpt', 'bosa-real-estate' ),
		'description'  => esc_html__( 'Disables excerpt for thumbnail post only.', 'bosa-real-estate' ),
		'type'         => 'checkbox',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Disable Post Button', 'bosa-real-estate' ),
		'description'  => esc_html__( 'Disables button for thumbnail post only.', 'bosa-real-estate' ),
		'type'         => 'checkbox',
	...
	Kirki::add_section( 'blog_services', array(
	    'title'          => esc_html__( 'Services', 'bosa-real-estate' ),
	    'panel'          => 'blog_homepage_options',
	    'capability'     => 'edit_theme_options',
	    'priority'       => 26,
	) );
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Disable Services Section', 'bosa-real-estate' ),
		'type'         => 'checkbox',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Disable Services', 'bosa-real-estate' ),
		'type'         => 'checkbox',
	...
	Kirki::add_section('blog_events_highlight',array(
		'title'          => esc_html__( 'Events Highlights', 'bosa-real-estate' ),
	    'panel'          => 'blog_homepage_options',
	    'capability'     => 'edit_theme_options',
	    'priority'       => 27,
	));
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Disable Events Highlight Section', 'bosa-real-estate' ),
		'type'         => 'checkbox',
	...
	Kirki::add_field('bosa', array(
		'label'       => esc_html__( 'Page 5', 'bosa-real-estate' ),
		'type'        => 'select',
		'settings'    => 'blog_events_highlight_page_five',
		'section'     => 'blog_events_highlight',
		'default'     => '',
		'placeholder' => esc_html__( 'Select Page 5', 'bosa-real-estate' ),
		'choices'     => bosa_real_estate_get_pages(),
		'priority'	  => 60,
	));

	kirki::add_field('bosa',array(
		'label'        => esc_html__( 'Disable Events Highlights', 'bosa-real-estate' ),
		'type'         => 'checkbox',
	...
	Kirki::add_section( 'blog_clients', array(
	    'title'          => esc_html__( 'Clients', 'bosa-real-estate' ),
	    'panel'          => 'blog_homepage_options',
	    'capability'     => 'edit_theme_options',
	    'priority'       => 28,
	) );
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Disable Clients Section', 'bosa-real-estate' ),
		'type'         => 'checkbox',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Tagline', 'bosa-real-estate' ),
		'type'        => 'text',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Client 1', 'bosa-real-estate' ),
		'type'         => 'image',
	...
	kirki::add_field('bosa',array(
		'label'        => esc_html__( 'Client 2', 'bosa-real-estate' ),
		'type'         => 'image',
	...
	kirki::add_field('bosa',array(
		'label'        => esc_html__( 'Client 3', 'bosa-real-estate' ),
		'type'         => 'image',
	...
	kirki::add_field('bosa',array(
		'label'        => esc_html__( 'Client 4', 'bosa-real-estate' ),
		'type'         => 'image',
	...
	kirki::add_field('bosa',array(
		'label'        => esc_html__( 'Client 5', 'bosa-real-estate' ),
		'type'         => 'image',
	...
	kirki::add_field('bosa',array(
		'label'        => esc_html__( 'Client 6', 'bosa-real-estate' ),
		'type'         => 'image',
	...
	kirki::add_field('bosa',array(
		'label'        => esc_html__( 'Disable Clients', 'bosa-real-estate' ),
		'type'         => 'checkbox',
	...
	Kirki::add_section( 'blog_opinions', array(
	    'title'          => esc_html__( 'Opinions', 'bosa-real-estate' ),
	    'panel'          => 'blog_homepage_options',
	    'capability'     => 'edit_theme_options',
	    'priority'       => 29,
	) );
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Disable opinions Section', 'bosa-real-estate' ),
		'type'         => 'checkbox',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Disable opinions', 'bosa-real-estate' ),
		'type'         => 'checkbox',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Product Title Typography', 'bosa-real-estate' ),
		'type'         => 'typography',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Product Price Typography', 'bosa-real-estate' ),
		'type'         => 'typography',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Add to Cart Button Typography', 'bosa-real-estate' ),
		'type'         => 'typography',
