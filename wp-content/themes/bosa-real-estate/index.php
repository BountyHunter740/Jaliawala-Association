...
?>
	...
	<div id="content" class="site-content">
		<div class="container">
			...
			<?php bosa_real_estate_blog_advertisement_banner(); ?>
			...
			<!--Event Highlight-->
			<?php get_template_part( 'template-parts/events-highlights/events-highlights' ); ?>
			
			<!--Clients-->
			<?php get_template_part( 'template-parts/clients/clients' ); ?>

			<!--Opinions-->
			<?php get_template_part( 'template-parts/opinions/opinions' ); ?>
							...
							<?php
								if( !get_theme_mod( 'disable_pagination', false ) ):
									the_posts_pagination( array(
										...
										'next_text' => '<span>'.esc_html__( 'Next', 'bosa-real-estate' ) .'</span><span class="screen-reader-text">' . esc_html__( 'Next page', 'bosa-real-estate' ) . '</span>',
										'prev_text' => '<span>'.esc_html__( 'Prev', 'bosa-real-estate' ) .'</span><span class="screen-reader-text">' . esc_html__( 'Previous page', 'bosa-real-estate' ) . '</span>',
										'before_page_number' => '<span class="meta-nav screen-reader-text">' . esc_html__( 'Page', 'bosa-real-estate' ) . ' </span>',
									));
								endif;
								wp_reset_postdata();
							?>
